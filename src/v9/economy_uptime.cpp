...
//
// **This is version eight's file carried unchanged**, which is the shape the
// version-eight port established and version nine repeats: what one version adds
// to the state lives in one translation unit, so the difference between two
// codecs is a file rather than a diff spread across eleven. Version nine's own
// addition is `economy_calendar.cpp`, and this file is version eight's with
// three identifiers rebound and nothing else.
//
