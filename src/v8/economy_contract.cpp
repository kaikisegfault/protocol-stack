...
// renumbered and no name is ever reused.
...
constexpr std::array<std::size_t, 22> kBodyBytes{
...
constexpr std::array<std::uint8_t, 22> kKindScheme{
    kNoScheme,        // 0
    kSchemeSigner,    // 1
    kSchemeSigner,    // 2
    kSchemeSigner,    // 3
...
// eight's two entries take 18 and 19 rather than filling a gap.
constexpr std::array<std::uint8_t, 3> kRetiredEntryKinds{7, 9, 11};

constexpr std::array<std::size_t, 20> kEntryKeyBytes{
...
constexpr std::array<std::size_t, 20> kEntryValueBytes{
    kUnassigned,     // 0
    82,              // 1  seat
    16,              // 2  channel
