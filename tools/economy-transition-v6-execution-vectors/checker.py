...
The checker fails in both directions, exactly as version six's does: a derived
key the file does not carry is a failure, and a recorded key no derivation
...
# tools/economy-transition-v6-execution-vectors/expected.py, which imports
...
#
# These vectors record what a version-six chain *does*. The byte surface it
# does it over is test-vectors/economy-transition-v6.txt.
"""
