"""Ordered, failure-atomic Founder Economy v3 simulation engine.

Identical to version two's engine apart from its four domain labels. The
journal conservation rules, the clone-and-commit discipline, and the assertion
that a rejected event changes nothing are unchanged.
"""
...
from ..founder_economy_v2.manifest import Manifest, load_manifest_file
from .metrics import build_metrics
from .operations import CARRY_BUCKET, JournalEntry, Outcome, failure, journal_delta
from .validation import parse_events

RESULT_SCHEMA = "protocol-stack/founder-economy-simulation-result/v3"
EVENTS_LABEL = "protocol-stack:founder-economy:events-v3"
TRACE_LABEL = "protocol-stack:founder-economy:trace-v3"
RESULT_LABEL = "protocol-stack:founder-economy:result-v3"
