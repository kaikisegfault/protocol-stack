#!/usr/bin/env python3
"""Run a version-one Founder Economy simulation."""
...
from simulation.founder_economy.manifest import ManifestError, load_manifest_file
from simulation.founder_economy.validation import InputError, load_events_file

DEFAULT_MANIFEST = (
    Path(__file__).resolve().parents[2]
    / "test-vectors"
    / "founder-economy-manifest-v1.json"
)
